...
const CartContainer = ({item, setFlag, flag}) => {
                ...
                <motion.p 
                  whileTap={{scale : 0.75}} 
                    className='flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 rounded-md hover:shadow-md
                     cursor-pointer text-textColor text-base'>Clear <RiRefreshFill />{" "} 
                </motion.p>
        </div>
        ...
        <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
            ...
            <div className='w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center
             justify-evenly px-8 py-2'>
                ...
                {user ? (
                    <motion.button whileTap={{scale: 0.8}} type='button' className=' w-full p-2 rounded-full bg-yellow-600 text-gray-50

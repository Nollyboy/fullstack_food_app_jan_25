...
const MainContainer = () => {
  ...
  return (
    <div className='w-full h-auto flex flex-col items-center justify-center'>
        ...
        <section className='w-full sm:mt-16 md:mt-32 lg:mt-6'>
          <div className='w-full flex items-center justify-between'>
            <p className='text-2xl font-semibold capitalize text-headingColor 
            relative before:absolute before:rounded-lg before:content before:w-32 before:h-1 
            ...
            transition-all ease-in-out duration-100'>
              ...
              <div className='hidden md:flex gap-3 items-center'>
                ...
                onClick={() => setScollValue(prevValue => prevValue - 200)}>
